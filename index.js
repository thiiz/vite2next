...
import { cleanupViteFiles } from './src/cleanup.js';
import { migrateDependencies } from './src/dependencies.js';
import { createEntrypoint } from './src/entrypoint.js';
import { migrateEnvVars } from './src/envVars.js';
import { updateImageImports } from './src/images.js';
import { createNextConfig } from './src/nextConfig.js';
import { updatePackageJson } from './src/packageJson.js';
import { createRootLayout } from './src/rootLayout.js';
import { migrateReactRouter } from './src/routerMigration.js';
import { migrateStaticAssets } from './src/staticAssets.js';
...
function displayMigrationSteps() {
    ...
    console.log(chalk.gray('1. Install Next.js dependencies'));
    console.log(chalk.gray('2. Create Next.js configuration file'));
    console.log(chalk.gray('3. Update TypeScript configuration (if applicable)'));
    console.log(chalk.gray('4. Create root layout file'));
    console.log(chalk.gray('5. Create entrypoint page'));
    console.log(chalk.gray('6. Update static image imports'));
    console.log(chalk.gray('7. Migrate environment variables'));
    console.log(chalk.gray('8. Update package.json scripts'));
    console.log(chalk.gray('9. Clean up Vite files'));
